                                ...
                                const uint8_t *pixels)
{
    ...
    ImageIndex index = ImageIndex::MakeFromTarget(target, level, size);
                                   ...
                                   const uint8_t *pixels)
{
    ...
    ImageIndex index = ImageIndex::MakeFromTarget(target, level, area);
                                      ...
                                      Texture *source)
{
    ...
    ImageIndex index = ImageIndex::MakeFromTarget(target, level, sourceBox);
                                                 ...
                                                 const gl::Box &area)
{
    ...
    ImageIndex imageIndex = ImageIndex::MakeFromTarget(target, static_cast<GLint>(level), area);
